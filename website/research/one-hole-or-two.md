...
The developer photographed the targets on the bench and opened one in GroupLab with the right calibre entered. **All fifteen of its holes were flagged as possibly two shots.** Fifteen review items on a sheet with nothing wrong with it.
...
Every one read with the calibre the developer actually shot, stated:
...
**Enter the calibre anyway.** The rule changed because the calibre was the wrong reference for deciding whether a mark is one hole or two, not because the calibre is useless. It still sets the smallest hole GroupLab will accept, and on rimfire that is the difference between finding twenty four marks and nineteen.
