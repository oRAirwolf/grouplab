...
data:
  - data/scan-facts.csv
sources:
  - "GroupLab notes on Alan Hayes's second range day, entry 120, section 4 (docs/NOTES-FROM-PLANNING.md)."
...
Many flatbeds cannot capture a whole letter or A4 page. Alan's scanner produced images of 4958 by 6458 pixels at 600 dpi: 8.26 by 10.76 inches, from an 8.5 by 11 inch sheet.
