...
- **The zero correction** says what to dial, in your scope's clicks, and refuses when the group's center is too close to the aim to tell from chance, saying how many shots would settle it.
...
- **The zero correction is given in MOA, mils, inches and centimeters at once**, with your scope's own unit leading and the clicks spelled out where the rifle records a click value. The clicks are never guessed.
