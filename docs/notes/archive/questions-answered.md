...
**Status: closed.** Answered 2026-09-24 by entry 187 section 2: 40 degrees stays until request 18 measures it; the score's levels stand as judgment and every part of every score travels with a submission; for a white board both the guidance and the corners placed by hand, which must never fail.
...
**Status: closed.** Answered 2026-09-24 by entry 187 section 3: all three accepted. The pooled velocity share is taken out per session the next time the pooling is touched, not as work of its own.
...
**Status: closed.** Answered 2026-09-24 by entry 187 section 4: option A, the next time a stable release is asked for.
...
**Status: closed.** Answered 2026-09-24 by entry 187 section 6: option 2, quietly, as a hint beside the control rather than a review item.
