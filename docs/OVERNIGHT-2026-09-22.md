...
**Next step:** entry 130 section 2c's pairing, each photograph to its own scan by hole pattern, which sections 2c and 6b both wait on. After it, entry 130 section 6 (performance) and questions 34 and 36.
