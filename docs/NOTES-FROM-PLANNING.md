...
- **Items 2 (apart from 2.1), 2b.1, 2b.4, 2b.5, 2b.6, 2c, 3.2, 3.5, 6 and 7, not done:** the night ran out. 2b.1, 2b.4, 2b.5, 2b.6 and 2c all need the real scans and photographs read and re-run, and 3.5 is explicitly to be done only after 2b. None was started and left half built.
