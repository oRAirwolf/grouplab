...
Entry 157 section 4 builds the grid registration and entry 158 program A the rest; they carry these, in the queue. Entry 157 built the corner, angle and perspective pieces without the grid: the ST-4's paper cannot be outlined on the white board it was shot on, and its grid is not detected, so section 3 item 4 still waits, with 158.
