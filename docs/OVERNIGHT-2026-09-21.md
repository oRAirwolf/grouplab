...
| Entry 139, signing the bytes as published | **done, every section**: `28a3365`, and section 5 proved from nightly 44 to nightly 49. Nightly 44 reads only the first format and nightly 49 is the first to publish both, so it is the proof that a build in the field still updates itself |
